...
- Create Angular project with ng: `ng new workitemestimate.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`workitemestimate.client.esproj`).
